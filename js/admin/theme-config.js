    ...
    var themeConfig = {
        ...
        build: function () {
            ...
            $.each(themeConfig.colors, function (i, value) {
                var color_v = jQuery('.color_value').val();
                var classs = "";
                if (color_v == themeConfig.colors[i].colorName) {
                    classs = "active";
                }
            ...
            themeColorList.find('a').click(function (e) {
                ...
                themeColorList.find('a').removeClass('active');
        ...
        setColor: function (color) {
            ...
            jQuery('.color_value').trigger('change');

        },
        setLayout: function (layout) {
            //$('body').removeAttr('class');

            $('.colors-theme').removeClass('wide').removeClass('boxed');
            $('.colors-theme').addClass(layout);
